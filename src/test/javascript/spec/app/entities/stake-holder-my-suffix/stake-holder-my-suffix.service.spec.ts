...
describe('Service Tests', () => {
    ...
    describe('StakeHolderMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(StakeHolderMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/stake-holders';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return StakeHolderMySuffix', () => {
